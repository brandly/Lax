  ...
  render() {
    ...
    return <React.Fragment>
        <div className="connection-tabs">
          <ul>
            {connections.map((conn, i) => <Tab key={conn.id} selected={route.view === 'CONNECTION' && route.connectionId === conn.id} onClick={() => {
            dispatch({
            ...
            <li className="tab tab-settings-link" style={{
...
const Tab = props => <li className={classNames('tab', {
...
const GearIcon = props => <svg viewBox="0 0 24 24" stroke="transparent" fill={props.color} style={{
  display: 'block'
}}>
