...
import type { Store as ReduxStore // Dispatch as ReduxDispatch
} from "redux";
...
type IrcConnectionStream = {
  ...
  notice: (arg0: string, arg1: string) => void;
...
type MessageType = "notice" | "priv" | "action" | "motd" | "welcome" | "topic" | "flow" | "join" | "away" | "part" | "quit" | "error";
