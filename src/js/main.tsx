...
const composeEnhancers = inProduction ? compose : window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || compose;
if (!inProduction) middleware.push(require('redux-logger').default);
const store: ReduxStore = createStore(rootReducer, initialState, composeEnhancers(applyMiddleware.apply(null, middleware)));
